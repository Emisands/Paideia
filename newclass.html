						...
						<section class="wrapper style5">
							<div class="inner">
								...
								<!-- Se for professor casatra nova sala -->
									<form name ="newClassCad" method="post" action="#">
										<div class="">
										<center>
										</br>
											<div class="6u$ 12u$(xsmall)">
												<input type="text" name="class-name" id="class-name" value="" placeholder="Nome da Classe" />
											</div>
										</br>
											<div class="6u$ 12u$(xsmall)">
												<!-- echo php mostra código sala -->
											</div>
										</br>
										</div>
										</br>
											<div class="12u$">
												<center>
												<ul class="actions">
													<li><input type="submit" value="Criar Sala" class="special" /></li>
												</ul>
												</center>
											</div>
										</center>
